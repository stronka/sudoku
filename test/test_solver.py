...
class TestSolver(unittest.TestCase):
    ...
    def test_BruteForceSudoku_SudokuMissingOneElement_SolveSudoku(self):
        sudoku = numpy.array([
            [7, 2, 5,    6, 4, 3,   9, 1, 8],
            [8, 3, 1,    7, 9, 2,   4, 6, 5],
            [9, 6, 4,    1, 8, 5,   3, 2, 7],
    ...
    def test_BruteForceSudoku_SudokuMissingTwoElements_SolveSudoku(self):
        sudoku = numpy.array([
            [7, 2, 5,    6, 4, 3,   9, 1, 8],
            [8, 3, 1,    7, 9, 2,   4, 6, 5],
            [9, 6, 4,    1, 8, 5,   3, 2, 7],
    ...
    def test_BruteForceSudoku_SudokuMissingOneElementInLastRow_SolveSudoku(self):
        sudoku = numpy.array([
            [7, 2, 5,    6, 4, 3,   9, 1, 8],
            [8, 3, 1,    7, 9, 2,   4, 6, 5],
            [9, 6, 4,    1, 8, 5,   3, 2, 7],
    ...
    def test_BruteForceSudoku_EmptyLastRow_SolveSudoku(self):
        sudoku = numpy.array([
            [7, 2, 5,    6, 4, 3,   9, 1, 8],
            [8, 3, 1,    7, 9, 2,   4, 6, 5],
            [9, 6, 4,    1, 8, 5,   3, 2, 7],
