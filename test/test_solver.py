...
class TestSolver(unittest.TestCase):
    ...
    def test_BruteForceSudoku_SudokuMissingTwoElements_SolveLastTwo(self):
        sudoku = numpy.array([
            [7, 2, 5,    6, 4, 3,   9, 1, 8],
            [8, 3, 1,    7, 9, 2,   4, 6, 5],
            [9, 6, 4,    1, 8, 5,   3, 2, 7],
    ...
    def test_BruteForceSudoku_SudokuMissingThreeElements_SolveLastTThree(self):
        sudoku = numpy.array([
            [7, 2, 5,    6, 4, 3,   9, 1, 8],
            [8, 3, 1,    7, 9, 2,   4, 6, 5],
            [9, 6, 4,    1, 8, 5,   3, 2, 7],
    ...
    def test_BruteForceSudoku_SudokuMissingThreeElements_SolveLastTwo(self):
        sudoku = numpy.array([
            [7, 2, 5,    6, 4, 3,   9, 1, 8],
            [8, 3, 1,    7, 9, 2,   4, 6, 5],
            [9, 6, 4,    1, 8, 5,   3, 2, 7],
